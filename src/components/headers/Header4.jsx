...
export default function Header4({ fullWidth = false }) {
  return (
    <header className="tf-header">
      <div className="inner-header bg-primary line-bt">
                ...
                <ul className="nav-icon justify-content-xl-center">
                  <li className="nav-account">
                    <a
                      ...
                      className="link-fill nav-icon-item"
                    >
                      <span>
                        <svg
                          width={26}
                  ...
                  <li className="nav-support d-none d-xl-block">
                    <Link
                      to={`/wishlist`}
                      className="link-fill nav-icon-item relative"
                    >
                      <span>
                        <svg
                          width={26}
      ...
      <div className="header-bottom d-none d-xl-block bg-dark">
        <div className={`container${fullWidth ? "-full" : ""}`}>
          <div className="row">
            <div className="col-xxl-9 col-8">
              <div className="header-bt-left active-container bg-dark">
