  ...
  return (
    <footer className="tf-footer">
      <div className="ft-body-wrap">
        ...
        <div className="ft-body-center bg-dark">
          <div className={`container${fullWidth ? "-full" : ""}`}>
              ...
              >
                ...
                <div className="subscribe-content">
                  ...
                  <div className="button-submit">
                    <button
                      className="subscribe-button bg-primary tf-btn btn-large hover-shine"
                      type="submit"
                    >
                      <span className="body-md-2 fw-semibold text-dark">
                        Subscribe
                      </span>
                    </button>
                  </div>
          ...
          <div className={`container${fullWidth ? "-full" : ""}`}>
            <div className="ft-bottom">
              ...
              <p className="nocopy caption text-center">
                <span className="fw-medium">MediaStore.</span>© 2025. All right
                reserved - Designed by MediaStore
              </p>
            </div>
          </div>
        </div>
